 ...
 * 描述
 */
public class OkHttpParameterConfiguration {
    ...
    private OkHttpParameterConfiguration(final Builder builder) {
    ...
    public static class Builder {
        ...
        public OkHttpParameterConfiguration build() {
            return new OkHttpParameterConfiguration(this);
        }
    }
